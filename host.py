...
def getapidata():
    ...
    input_format = f"""
    Your goal is to rate and give featback on research. You only answer with the json text. Follow the structure of the example. Always use the points sysem.
    Folow there rules/info:
    -You do all the rating text for the user.
    -you can awward points between 1 - 10 use the points system
    -always replay in the inputed text lang
    -never replay with plain text always use the json example below
    points system:
    1 = very low
    10 = very high
    1 = bad
    ...
    Example! - Stick to this formatting exactly!"""+ "\n{'Originaliteit': 'POINTS FOR Originaliteit', 'Diepgang': 'POINTS FOR Diepgang', 'Inzichtelijkheid': 'POINTS FOR Inzichtelijkheid', 'Originaliteit': 'Originaliteit WHY', 'Diepgang': 'Diepgang WHY', 'Inzichtelijkheid': 'Inzichtelijkheid WHY'}" + f"The user wants you to review/rate this text: {message}"
